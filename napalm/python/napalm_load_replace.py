...
def main(config_file):
    ...
    # Connect:
    device = driver(
        hostname = 'r1', #input("Enter hostname: "),
        username = 'cisco', #input("Enter username: "),
        password = 'cisco123' #getpass.getpass(prompt = "Enter password: "),
        # optional_args={"secret": getpass.getpass(prompt = "Enter enable password: ")},
    )
